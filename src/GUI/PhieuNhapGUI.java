...
public class PhieuNhapGUI extends JPanel{
   ...
   String [] searchs={"Tìm Theo Mã Phiếu Nhập", "Tìm Theo Tên Nhân Viên", "Tìm Theo Mã Nhân Viên","Tìm TheoTên Nhà Xuất Bản", "Tìm Theo Mã Nhà Xuất Bản"};
  ...
  String [] thongke={"Chọn Yêu Cầu Thống Kê","Thống Kê Theo Ngày ", "Thống Kê Theo Khoảng Thời Gian ","Thống Kê Theo Tháng Năm"};
                  ...
                  switch(selectedIndex){
                      case 0:{
                          ...
                          if(userInput.isEmpty())
                                         JOptionPane.showMessageDialog(null, "Hãy nhập mã phiếu nhập mà bạn muốn tìm kiếm !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                                   else{
                                           if(KiemTraMa5(userInput)==true){
                                                   ...
                                                   if(objtrung.isEmpty()==true)
                                                        JOptionPane.showMessageDialog(null, "Không tìm thấy phiếu nhập nào có mã giống với mã mà bạn đang tìm kiếm.");
                                                   else{
                                               ...
                                               JOptionPane.showMessageDialog(null, "Mã bạn nhập không đúng !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                                           }
                                  }
                          break;
                      }
                      ...
                      case 1:{
                          //TÌM THEO TÊN NHÂN VIÊN
                           String userInput = txt_Search.getText();
                            if(userInput.isEmpty())
                                         JOptionPane.showMessageDialog(null, "Hãy nhập tên nhân viên mà bạn muốn tìm kiếm !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                            else{
                                    ArrayList<PhieuNhap>objtrung=phieunhapbus.TimKiemTheoTenNhanVien(userInput);
                                    //Danh sách rỗng
                                    if(objtrung.isEmpty()==true)
                                         JOptionPane.showMessageDialog(null, "Không tìm thấy phiếu nhập nào có tên nhân viên giống với tên nhân viên mà bạn đang tìm kiếm.");
                                    else{
                                        ThemDataVaoJTablePhieuNhap(model,objtrung);
                                    } 
                                    txt_Search.setText("");
                      ...
                      case 2:{
                          //TÌM THEO MÃ NHÂN VIÊN
                            String userInput = txt_Search.getText();
                          if(userInput.isEmpty())
                                         JOptionPane.showMessageDialog(null, "Hãy nhập mã nhân viên mà bạn muốn tìm kiếm !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                                   else{
                      ...
                      case 3:{
                          //TÌM THEO TÊN NHÀ XUẤT BẢN
                            String userInput = txt_Search.getText();
                            if(userInput.isEmpty())
                                         JOptionPane.showMessageDialog(null, "Hãy nhập tên nhà xuất bản  mà bạn muốn tìm kiếm !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                            else{
                                    ArrayList<PhieuNhap>objtrung=phieunhapbus.TimKiemTheoTenNhaXuatBan(userInput);
                                    //Danh sách rỗng
                                    if(objtrung.isEmpty()==true)
                                         JOptionPane.showMessageDialog(null, "Không tìm thấy phiếu nhập nào có tên nhà xuất bản giống với tên nhà xuất bản mà bạn đang tìm kiếm.");
                                    else{
                                        ThemDataVaoJTablePhieuNhap(model,objtrung);
                                    } 
                                    txt_Search.setText("");
                      ...
                      case 4:{
                             String userInput = txt_Search.getText();
                          if(userInput.isEmpty())
                                         JOptionPane.showMessageDialog(null, "Hãy nhập mã nhà xuất bản mà bạn muốn tìm kiếm !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                                   else{
                                           if(KiemTraMa4(userInput)==true){
      ...
      detail.addActionListener(new ActionListener() {  
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow == -1) {
                    ...
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn một phiếu nhập!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                }else{
...
panel_date1.add(end_date);
        ...
        btn_close_thongke.addActionListener(new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
                int option=JOptionPane.showConfirmDialog(null, "Bạn có muốn tiếp tục hành động này không?", "Xác nhận", JOptionPane.OK_CANCEL_OPTION);
  ...
  public JPanel ThemPhieuNhapGUI(){
    ...
    // Lấy thời gian hiện tại
     ...
     //Đổi từ local date sang date
      ...
      // Format thời gian theo định dạng cụ thể, ở đây mình chọn định dạng 'yyyy-MM-dd'
  ...
  nxb_t.addActionListener(new ActionListener() {
    ...
    public void actionPerformed(ActionEvent e) {
            if(list_sachincombobox.isEmpty()!=true){
                    int option=JOptionPane.showConfirmDialog(null, "Nếu bạn chọn nhà xuất bản khác thì toàn bộ những gì bạn nhập sẽ bị xóa hết !Bạn có chắc chắn muốn chọn nhà xuất bản khác không?", "Xác nhận", JOptionPane.OK_CANCEL_OPTION);
                        if(option==JOptionPane.CANCEL_OPTION){
                            return;
                        }
            }
     ...
     //NAVIGATOR
       ...
       btn_themsachmoi.setPreferredSize(new Dimension(200,60));
        ...
        btn_themsachcu.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                if(  list_sachincombobox.isEmpty()==true){
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn nhà xuất bản !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                    return;
                }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(selectedIndex!=-1){
                    ...
                    if(txt_solg.isEmpty()||!Pattern.matches(regex, txt_solg)){
                         JOptionPane.showMessageDialog(null, "Vui lòng nhập số lượng đầy đủ và chính xác !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                         return;
                    }
                    ...
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn tên sách mà bạn muốn thêm số lượng mới !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                }
        ...
        manv.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
	            ...
	            if(ma.isEmpty()||KiemTraMa4(ma)==false){
	                    JOptionPane.showMessageDialog(null, "Vui lòng không để trống ô này !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
	                    return;
	            }
	              int ktra=0;
	            ...
	            if(ktra==0){
	                    JOptionPane.showMessageDialog(null, "Vui lòng nhập đúng mã nhân viên của bạn !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
	                    return;
	            }
    ...
    panel_themsach_temp7.setBackground(Color.WHITE);
        ...
        btn_themsachmoi1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                ...
                if(!Pattern.matches( regexyear,namxb)||namxb.isEmpty()||ten_sach.isEmpty()||mota.isEmpty()||dongia.isEmpty()||solg.isEmpty()||!Pattern.matches(regex,solg)||!Pattern.matches(currencyPattern,dongia)||tacgia_option==-1||lsach_option==-1){
                        JOptionPane.showMessageDialog(null, "Vui lòng nhập đúng và đầy đủ !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                        return;
                }
