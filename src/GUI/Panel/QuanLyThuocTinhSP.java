...
public class QuanLyThuocTinhSP extends JPanel {
    ...
    // String iconst[] = { "brand_100px.svg", "factory_100px.svg", "os_100px.svg", "rom_100px.svg", "ram_100px.svg",
    //         "color_100px.svg" };

    String iconst[] = { "brand_100px.svg", "os_100px.svg", "rom_100px.svg", "ram_100px.svg",
            "color_100px.svg" };

    String header[] = { "Thương hiệu", "Hệ điều hành", "Ram", "Rom", "Màu sắc" };
    ...
    private void initComponent() {
        ...
        contentCenter.setLayout(new GridLayout(2, 3, 20, 20));
